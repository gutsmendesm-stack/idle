/* TB-WM u=23 e=33e1ffb3e5 x=f2e5047b9289 t=1785383860 s=fc3a15815e861388 */
(function(){try{window.__TIBIABOT_WM__={u:23,t:1785383860,x:"f2e5047b9289",s:"fc3a15815e861388"};}catch(e){}})();
...
// Módulo Baiak Idle (MAIN): Member Dead
// - Detecta .member.dead → Cidade (confirma DOM) → hunt ativa
// - start()/stop() controlados pela extensão
// - Espelho do Pular Boss (mesma lógica de escape)
    ...
    class BaiakIdleMemberDeadModule {
        ...
        _verificarMemberDead() {
            ...
            try {
                const S = this._sel();
                if (!S?.MEMBER_DEAD) {
                    this._log('BaiakIdleSeletores.MEMBER_DEAD indisponível');
                    return false;
                }
                ...
                this._log('Member dead detectado! Cidade → hunt ativa...');
